...
LOCALMODLIBS=
BASEMODLIBS=       -lmytinfo -lreadline -ltermcap    -lm             -lcrypt
SHAREDMODS= kqsyscallmodule$(SO)
TKPATH=:lib-tk
...
kqsyscallmodule.o: $(srcdir)/kqsyscallmodule.c; $(CC) $(CCSHARED)  $(CFLAGS) -c $(srcdir)/kqsyscallmodule.c
kqsyscallmodule$(SO):  kqsyscallmodule.o; $(LDSHARED)  kqsyscallmodule.o  -o kqsyscallmodule$(SO)
